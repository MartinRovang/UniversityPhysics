...
\section{Implementasjon}
    ...
    {\centering
        ...
        \caption{Profil av programmet, her kan man se de hvor lang tid de forskjellige funksjonene brukte og antall kall det var til dem. Her har det blitt brukt \emph{cProfiler} sammen med visualiseringsbiblioteket \emph{snakeviz}}
        \label{profilings}
    \par}
    \end{figure}
    ...
    \begin{figure}[hbt!]
        ...
        def somefunction():
            .....
        \end{lstlisting}
    \caption{Hvordan dekoratoren ble brukt i koden.}
    \label{Kode1}
    \end{figure}
